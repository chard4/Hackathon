...
public class VocabHelper
{
    ...
    private void createAndShowGUI()
    {
        ...
        helper.setPreferredSize(new Dimension(370,500));
    ...
    private void createMenuBar()
    {
        ...
        JMenuItem flip = new JMenuItem("Switch Sides", KeyEvent.VK_W);
        flip.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_W, ActionEvent.ALT_MASK));
        flip.getAccessibleContext().setAccessibleDescription("Words = Defs and Defs = Words");
    ...
    private void switchWordsClues()//#8
    {
    	if (!pickFile())
            return;
        doneWithWord = true;
